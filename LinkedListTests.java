public class LinkedListTests {
    ...
    //     System.out.println("Removing the first element from the queue: " + queue.remove());
    //     System.out.println("Queue after removing the first element: " + queue);

    //     System.out.println("Adding two elements to the queue: ");
    //     queue.add(40);
    //     queue.add(50);
    //     System.out.println("Queue after adding two elements: " + queue);

    //     System.out.println("Removing the first two elements from the queue: ");
    //     System.out.println(queue.remove());
    //     System.out.println(queue.remove());
    //     System.out.println("Queue after removing the first two elements: " + queue);

    //     System.out.println("Adding one element to the queue: ");
    //     queue.add(60);
    //     System.out.println("Queue after adding one element: " + queue);

    //     System.out.println("Removing all the elements from the queue: ");
    //     while (!queue.isEmpty()) {
    //         System.out.println(queue.remove());
    //     }
    //     System.out.println("Queue after removing all the elements: " + queue);
    // }
